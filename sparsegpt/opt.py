...
def get_opt(model):
    ...
    model = OPTForCausalLM.from_pretrained(model, torch_dtype='auto',attn_implementation="eager")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
       '--data-root', type=str, default='/home/zhaojun/proj26/datasets',
       help='Path to local datasets directory.'
    )
    ...
    dataloader, testloader = get_loaders(
        args.dataset, nsamples=args.nsamples, seed=args.seed, model=args.model, seqlen=model.seqlen, data_root=args.data_root
    )
