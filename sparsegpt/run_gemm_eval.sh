...
echo ""
echo "评估组合数: 5 configs × 3 datasets × $NUM_INFERENCES inferences = $((5 * 3 * NUM_INFERENCES)) 次评估"
echo ""
echo "配置列表:"
echo "  1. dense   - 无压缩基线"
echo "  2. gmp     - 幅度剪枝基准 (50%)"
echo "  3. sp50    - SparseGPT 50% 稀疏性"
echo "  4. 2:4     - SparseGPT 2:4 稀疏性"
echo "  5. sp50_q4 - SparseGPT 50% + 4-bit 量化"
echo ""
echo "数据集列表:"
echo "  1. wikitext2"
echo "  2. ptb"
